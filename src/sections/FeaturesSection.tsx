    ...
    <section id="features" className="w-full py-12 md:py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <CardHeader className="relative pb-2">
          <CardTitle className="text-xl font-bold">AExtensive Problem Library</CardTitle>
        </CardHeader>
        <CardContent className="relative flex h-40 items-center justify-center p-6">
          ...
          Access 2000+ coding challenges across 20+ categories from easy to hard difficulty levels.
          </span>
        </CardContent>
        <Pointer>
          <motion.div
      ...
      <Card className="col-span-1 row-span-1 overflow-hidden border bg-gradient-to-br from-blue-50 to-blue-100 transition-all dark:from-blue-900 dark:to-blue-800 shadow-none">
        <CardHeader className="relative pb-2">
          <CardTitle className="text-xl font-bold">Interactive Coding Environmen</CardTitle>
        </CardHeader>
        <CardContent className="relative flex h-40 items-center justify-center p-6">
          <span className="pointer-events-none text-center text-xl font-medium text-blue-800 dark:text-blue-200">
          Code in 15+ programming languages with our powerful online IDE with syntax highlighting and auto-completion.
          </span>
        </CardContent>
        ...
        <CardHeader className="relative pb-2">
          <CardTitle className="text-xl font-bold">Interview Preparation</CardTitle>
        </CardHeader>
        <CardContent className="relative flex h-40 items-center justify-center p-6">
          <span className="pointer-events-none text-center text-xl font-medium text-purple-800 dark:text-purple-200">
          Prepare for technical interviews with company-specific problem sets and mock interviews.
          </span>
        </CardContent>
        <Pointer>
          <svg
